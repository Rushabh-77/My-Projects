...
imgTest = face_recognition.load_image_file('imagesbasic/Jackma.jpg')
...
cv2.putText(imgTest,f'{results} {round(faceDist[0],2)}',(50,50), cv2.FONT_HERSHEY_SIMPLEX,1,(0,0,255), 1  )
